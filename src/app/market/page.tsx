...
export default function MarketPage() {
  const [selectedDemo, setSelectedDemo] = useState<
    'quote' | 'analysis' | 'watchlist' | 'chart'
  >('quote');
    ...
    <div className="container mx-auto space-y-8 px-4 py-8">
      ...
      <div className="space-y-4 text-center">
        ...
        <p className="text-muted-foreground mx-auto max-w-2xl text-xl">
          Demonstração dos componentes visuais para análise de mercado
          implementados na Priority 3 do Day 4
        </p>
      </div>
      ...
      <div className="space-y-6">
        {selectedDemo === 'quote' && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold">
              Quote Card - Componente de Cotação
            </h2>
        ...
        {selectedDemo === 'analysis' && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold">
              Analysis Card - Interface de Análise
            </h2>
        ...
        {selectedDemo === 'watchlist' && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold">
              Watchlist Dashboard - Dashboard de Mercado
            </h2>
            <WatchlistDashboard
        ...
        {selectedDemo === 'chart' && (
          <div className="space-y-6">
            <h2 className="text-2xl font-bold">
              Price Chart - Gráficos de Preços
            </h2>
