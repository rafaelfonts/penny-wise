...
interface UseNotificationsReturn {
  ...
  filterNotifications: (type?: NotificationType | 'all', unreadOnly?: boolean) => Notification[]
...
export function useNotifications(): UseNotificationsReturn {
  ...
  // Create notification
  const createNotification = useCallback(async (notification: CreateNotification) => {
    try {
  ...
  // Update preferences
  const updatePreferences = useCallback(async (updates: UpdateNotificationPreferences) => {
    try {
